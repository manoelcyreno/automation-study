...
describe('Cypress Web Form Test Suite2', function()
    {
        ...
        it(["critical"], 'Submit Web Form Page With Success2', function()
            {
        ...
        it(["medium"], 'Validate If Disable Input Is Disabled2', function()
            {
                const hpl = new HomePageLocators()
        ...
        it(["high"], 'Validate If Readonly Input Can Not Be Editable2', function()
            {
                const hpl = new HomePageLocators()
        ...
        it(["medium"], 'Validate If Web Form Page Is Accessible With Success2', function()
            {
